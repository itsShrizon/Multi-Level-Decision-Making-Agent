...
from app.shared.schemas import EventDetails
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": (
                                "You are a risk assessment expert for a law firm. Your job is to determine the client's long-term risk of leaving. "
                                "Your output MUST be a JSON object conforming to the `RiskAssessment` schema.\n"
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": (
                                "You are an expert in sentiment analysis. Classify the sentiment of the message as Positive, Neutral, or Negative.\n\n"
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": (
                                "You are an expert at identifying mentions of future events or appointments in messages. "
